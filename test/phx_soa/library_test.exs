defmodule PhxSoa.LibraryTest do
  use PhxSoa.DataCase
  ...
  describe "books" do
    ...
    @valid_attrs %{author: "some author", name: "some name", pages: 42}
    @update_attrs %{author: "some updated author", name: "some updated name", pages: 43}
